class SlidingWindowUtils:
    ...
    def maxConsecutiveAnswers(
        self, answerKey: str, k: int
    ) -> int:
        ans = left = 0
        cnt = defaultdict(int)
    ...
    # ░░░░░░░░░░░ LCP 68 —— 美观的花束 ░░░░░░░░░░░
    def beautifulBouquet(
        self, flowers: List[int], cnt: int
    ) -> int:
        ans = left = 0
        c = defaultdict(int)
